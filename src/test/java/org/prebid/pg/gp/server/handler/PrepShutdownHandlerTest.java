...
public class PrepShutdownHandlerTest extends HandlerTestBase {
    ...
    private PrepShutdownHandler prepShutdownHandler;

    @BeforeEach
    void setUp() {
        this.resourceRole = "admin";
        this.prepShutdownHandler = new PrepShutdownHandler(shutdownMock, resourceRole, securityEnabled);
    ...
    void shouldResponseWith403ForMissingCredential() {
        ...
        prepShutdownHandler.handle(routingContextMock);
